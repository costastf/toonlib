...
# -*- coding: utf-8 -*-
#
# toonlib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''toonlib''')])
...
version = toonlib.__version__
# The full version, including alpha/beta/rc tags.
release = toonlib.__version__
